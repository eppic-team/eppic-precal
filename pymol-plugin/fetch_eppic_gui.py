...
Mac users have to rename their application to PyMOLX11Hybrid.app(as explained in this link http://www.pymolwiki.org/index.php/Plugins)  to use this plugin.
